...
namespace YazanLib.Media
{
    public static class CustomRegions
    {
        ...
        */
        ...
        public static List<List<RegionData>> ImportEmbbededRegions(string filename)
        {
            System.IO.Stream stream = null;
            List<List<RegionData>> data = null;
            try
            {
                System.Runtime.Serialization.Formatters.Binary.BinaryFormatter binaryFormatter =
                    new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
                ...
                data = (List<List<RegionData>>)binaryFormatter.Deserialize(stream);
        ...
        public static void ExportEmbbededRegions(List<List<RegionData>> data, string filename)
        {
            System.Runtime.Serialization.Formatters.Binary.BinaryFormatter binaryFormatter =
                new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
