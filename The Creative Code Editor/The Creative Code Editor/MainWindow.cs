...
namespace Simple_Code_Editor
{
    ...
    public partial class MainWindow : Form
    {
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            if (!TextArea.Saved)
            {
                if (NoneMenuItem.Checked)
                {
                    saveFileDialogBox.Filter = "Text files (*.txt)|*.txt|Sql files (*.sql)|*.sql|C++ files (*.cpp;*.h;*.c)|*.cpp;*.h;*.c|C# files (*.cs)|*.cs|Java files (*.java)|*.java|Ada files (*.ada)|*.ada|Secure Codes (*.scf)|*.scf|All Files (*.*)|*.*";
                }
                else
                {
                    SetupCurrentLanguageDialogBox();
                }
                DialogResult res = System.Windows.Forms.MessageBox.Show("Do you want to save the file?", "Exit without saving", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                if (res == System.Windows.Forms.DialogResult.Yes)
                {
                    if (saveFileDialogBox.FileName == string.Empty)
                    {
                        ...
                        {
                            System.Windows.Forms.MessageBox.Show("Do you want to save the file?", "Exit without saving", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                    }
                    else
                    {
                ...
                {
                    e.Cancel = (res == System.Windows.Forms.DialogResult.Cancel);
                    if(e.Cancel)
                        return;
                }
            }
        ...
        private void SetupTextArea()
        {
            switch (currentLanguage)
            {
                case SupportedLanguage.SQL:
                    ...
                    TextArea.SkipQuotationCharacter = settings.Languages[SupportedLanguage.SQL].SkipQuotationsCharacter;
                    TextArea.HasSkipQuotationCharacter = settings.Languages[SupportedLanguage.SQL].HasSkipQuotationsCharacter;
                ...
                case SupportedLanguage.Ada:
                    ...
                    TextArea.SkipQuotationCharacter = settings.Languages[SupportedLanguage.Ada].SkipQuotationsCharacter;
                    TextArea.HasSkipQuotationCharacter = settings.Languages[SupportedLanguage.Ada].HasSkipQuotationsCharacter;
                    TextArea.KeywordsFont = settings.Languages[SupportedLanguage.SQL].KeywordsFont;
                ...
                case SupportedLanguage.CPP:
                    ...
                    TextArea.SkipQuotationCharacter = settings.Languages[SupportedLanguage.CPP].SkipQuotationsCharacter;
                    TextArea.HasSkipQuotationCharacter = settings.Languages[SupportedLanguage.CPP].HasSkipQuotationsCharacter;
                    TextArea.KeywordsFont = settings.Languages[SupportedLanguage.SQL].KeywordsFont;
                ...
                case SupportedLanguage.CS:
                    ...
                    TextArea.SkipQuotationCharacter = settings.Languages[SupportedLanguage.CS].SkipQuotationsCharacter;
                    TextArea.HasSkipQuotationCharacter = settings.Languages[SupportedLanguage.CS].HasSkipQuotationsCharacter;
                    TextArea.KeywordsFont = settings.Languages[SupportedLanguage.SQL].KeywordsFont;
                ...
                case SupportedLanguage.Java:
                    ...
                    TextArea.SkipQuotationCharacter = settings.Languages[SupportedLanguage.Java].SkipQuotationsCharacter;
                    TextArea.HasSkipQuotationCharacter = settings.Languages[SupportedLanguage.Java].HasSkipQuotationsCharacter;
                    TextArea.KeywordsFont = settings.Languages[SupportedLanguage.SQL].KeywordsFont;
        ...
        private void CapitalizeKeywords(ref List<Keyword> list)
        {
            for (int i = 0; i < list.Count; i++)
            {
                string text = "";
                for (int ii = 0; ii < list[i].Text.Length; ii++)
                    text += char.ToUpper(list[i].Text[ii]);
                list[i].Text = text;
            }
        }
        ...
        private void SetupSQLList()
        {
            ...
            keywords.Add(new Keyword("into")); keywords.Add(new Keyword("kill")); keywords.Add(new Keyword("each")); 
            ...
            keywords.Add(new Keyword("exception")); keywords.Add(new Keyword("switch"));
            ...
            keywords.Add(new Keyword("access")); keywords.Add(new Keyword("accept")); keywords.Add(new Keyword("prompt"));
            keywords.Add(new Keyword("name")); keywords.Add(new Keyword("password")); keywords.Add(new Keyword("using"));
            keywords.Add(new Keyword("start with")); keywords.Add(new Keyword("dual")); keywords.Add(new Keyword("commit"));
            keywords.Add(new Keyword("revoke")); keywords.Add(new Keyword("sysdate")); keywords.Add(new Keyword("data"));
            keywords.Add(new Keyword("true")); keywords.Add(new Keyword("false")); keywords.Add(new Keyword("rollback"));
            keywords.Add(new Keyword("rollback")); keywords.Add(new Keyword("commit"));

            keywords.Add(new Keyword("struct")); keywords.Add(new Keyword("class")); keywords.Add(new Keyword("union"));
            keywords.Add(new Keyword("pragma"));

            //datatypes
            keywords.Add(new Keyword("CLOB", KeywordType.DataType)); keywords.Add(new Keyword("BLOB", KeywordType.DataType));
            keywords.Add(new Keyword("NCLOB", KeywordType.DataType)); keywords.Add(new Keyword("BFILE", KeywordType.DataType));
            keywords.Add(new Keyword("LOB", KeywordType.DataType)); keywords.Add(new Keyword("NCHAR", KeywordType.DataType));
            ...
            keywords.Add(new Keyword("NVARCHAR2", KeywordType.DataType));
            ...
            keywords.Add(new Keyword("not null", KeywordType.Operator)); keywords.Add(new Keyword("not", KeywordType.Operator)); keywords.Add(new Keyword("enable", KeywordType.Operator));
            keywords.Add(new Keyword("to", KeywordType.Operator)); keywords.Add(new Keyword("on", KeywordType.Operator)); keywords.Add(new Keyword("off", KeywordType.Operator));
            ...
            keywords.Add(new Keyword("(+)", KeywordType.Operator)); keywords.Add(new Keyword("is", KeywordType.Operator)); keywords.Add(new Keyword("disable", KeywordType.Operator));
            
            Language lang = new Language();
            CapitalizeKeywords(ref keywords);
            ...
            lang.HasSkipQuotationsCharacter = false;
            lang.SkipQuotationsCharacter = '\\';
        ...
        private void SetupCPPList()
        {
            ...
            keywords.Add(new Keyword("__unhook")); keywords.Add(new Keyword("__value")); keywords.Add(new Keyword("#ifndef"));
            ...
            lang.FirstQuotationsCharacter = '"';
            lang.SecondQuotationsCharacter = '\'';
            lang.HasSkipQuotationsCharacter = true;
            lang.SkipQuotationsCharacter = '\\';
            lang.QuotationsColor = System.Drawing.Color.Red;
            lang.KeywordsFont = TextArea.Font;
            lang.Rules = RichTextBoxFinds.MatchCase | RichTextBoxFinds.WholeWord;
        ...
        private void SetupCSList()
        {
            ...
            keywords.Add(new Keyword("true")); keywords.Add(new Keyword("false")); keywords.Add(new Keyword("partial"));
            keywords.Add(new Keyword("foreach"));
        ...
        private void SetupCurrentLanguageDialogBox()
        {
